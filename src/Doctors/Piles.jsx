...
<div className="title   pb-8 pt-4 pl-4  border-[1px] border-slate-200   rounded-lg ">
    <h1 className='font-poppins font-bold text-[18px]'>11 Best Doctors For Piles And Hemorrhoid Surgery In Karachi</h1>
...
ماہر امراض بواسیر
        ...
        <div className="p-24">
    <CardFeverDoctor
        Img={'https://staticconnect.marham.pk/assets/doctors/11559/dr-mir-arsalan-ali-laproscopic-surgeon-karachi-23_170X170.webp'}
        name={'Dr. Mir Arsalan Ali'}
        verified={'PMDC Verified'}
        bio1={'Laparoscopic Surgeon'}
        bio2={'MBBS, FCPS (Surgery)'}
        Experience={'12 Yrs'}
        raing={'14'}
        satisfication={'100%'}
        charges={'900'}
        hospital={'Ziauddin Hospital North Nazimabad Campus, Wahid Colony, Karachi'}
        location={'Wahid Colony, Karachi'}

    />
      <CardFeverDoctor
        Img={'https://staticconnect.marham.pk/assets/doctors/21171/dr-waqas-rind-laparoscopic-surgeon-karachi-35_170X170.webp'}
        name={'Dr. Waqas Rind'}
        verified={'PMDC Verified'}
        bio1={'Laparoscopic Surgeon'}
        bio2={'MBBS, FCPS'}
